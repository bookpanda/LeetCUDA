...
# compile
```bash
# Standalone CUDA (use -arch=sm_XX for your GPU, e.g. sm_86 for RTX 3090)
nvcc -arch=sm_86 -o a.out basics/2-kernels/00_vector_add_v1.cu
...
TORCH_CUDA_ARCH_LIST=8.6 python histogram.py
```
